! function() {
    var a, o, d, s, t, n, e, i, r, l, m, c, u = document.querySelector(".navbar-menu").innerHTML,
        g = 7,
        b = "en",
    ...
    function h() {
        "vertical" == document.documentElement.getAttribute("data-layout") && (document.querySelector(".navbar-menu").innerHTML = u, document.getElementById("scrollbar").setAttribute("data-simplebar", ""), document.getElementById("navbar-nav").setAttribute("data-simplebar", ""), document.getElementById("scrollbar").classList.add("h-100")), "horizontal" == document.documentElement.getAttribute("data-layout") && B()
    }

    function v() {
        feather.replace();
        var e = document.documentElement.clientWidth,
            e = (e < 1025 && 767 < e ? (document.body.classList.remove("twocolumn-panel"), "twocolumn" == sessionStorage.getItem("data-layout") && (document.documentElement.setAttribute("data-layout", "twocolumn"), document.getElementById("customizer-layout03") && document.getElementById("customizer-layout03").click(), A(), E()), "vertical" == sessionStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", "sm"), document.querySelector(".hamburger-icon") && document.querySelector(".hamburger-icon").classList.add("open")) : 1025 <= e ? (document.body.classList.remove("twocolumn-panel"), "twocolumn" == sessionStorage.getItem("data-layout") && (document.documentElement.setAttribute("data-layout", "twocolumn"), document.getElementById("customizer-layout03") && document.getElementById("customizer-layout03").click(), A(), E()), "vertical" == sessionStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", sessionStorage.getItem("data-sidebar-size")), document.querySelector(".hamburger-icon") && document.querySelector(".hamburger-icon").classList.remove("open")) : e <= 767 && (document.body.classList.remove("vertical-sidebar-enable"), document.body.classList.add("twocolumn-panel"), "twocolumn" == sessionStorage.getItem("data-layout") && (document.documentElement.setAttribute("data-layout", "vertical"), z("vertical"), E()), "horizontal" != sessionStorage.getItem("data-layout") && document.documentElement.setAttribute("data-sidebar-size", "lg"), document.querySelector(".hamburger-icon")) && document.querySelector(".hamburger-icon").classList.add("open"), document.querySelectorAll("#navbar-nav > li.nav-item"));
        Array.from(e).forEach(function(e) {
        ...
        e && Array.from(e).forEach(function(n) {
            ! function e() {
                var t = +n.getAttribute("data-target"),
                    a = +n.innerText,
                    o = t / 250;
                o < 1 && (o = 1), a < t ? (n.innerText = (a + o).toFixed(0), setTimeout(e, 1)) : n.innerText = d(t), d(n.innerText)
            }()
        })
    }
    ...
    function C(a, e) {
        Array.from(document.querySelectorAll("input[name=" + a + "]")).forEach(function(t) {
            e == t.value ? t.checked = !0 : t.checked = !1, t.addEventListener("change", function() {
                var e;
                document.documentElement.setAttribute(a, t.value), sessionStorage.setItem(a, t.value), "data-layout-width" == a && "boxed" == t.value ? (document.documentElement.setAttribute("data-sidebar-size", "sm-hover"), sessionStorage.setItem("data-sidebar-size", "sm-hover"), document.getElementById("sidebar-size-small-hover").checked = !0) : "data-layout-width" == a && "fluid" == t.value && (document.documentElement.setAttribute("data-sidebar-size", "lg"), sessionStorage.setItem("data-sidebar-size", "lg"), document.getElementById("sidebar-size-default").checked = !0), "data-layout" == a && ("vertical" == t.value ? (z("vertical"), E(), feather.replace()) : "horizontal" == t.value ? (document.getElementById("sidebarimg-none") && document.getElementById("sidebarimg-none").click(), z("horizontal"), feather.replace()) : "twocolumn" == t.value && (z("twocolumn"), document.documentElement.setAttribute("data-layout-width", "fluid"), document.getElementById("layout-width-fluid").click(), A(), E(), feather.replace())), "data-preloader" == a && "enable" == t.value ? (document.documentElement.setAttribute("data-preloader", "enable"), (e = document.getElementById("preloader")) && setTimeout(function() {
    ...
    sessionStorage.getItem("defaultAttribute") ? ((a = {})["data-layout"] = sessionStorage.getItem("data-layout"), a["data-sidebar-size"] = sessionStorage.getItem("data-sidebar-size"), a["data-layout-mode"] = sessionStorage.getItem("data-layout-mode"), a["data-layout-width"] = sessionStorage.getItem("data-layout-width"), a["data-sidebar"] = sessionStorage.getItem("data-sidebar"), a["data-sidebar-image"] = sessionStorage.getItem("data-sidebar-image"), a["data-layout-position"] = sessionStorage.getItem("data-layout-position"), a["data-layout-style"] = sessionStorage.getItem("data-layout-style"), a["data-topbar"] = sessionStorage.getItem("data-topbar"), a["data-preloader"] = sessionStorage.getItem("data-preloader"), a["data-body-image"] = sessionStorage.getItem("data-body-image"), x(a)) : (i = document.documentElement.attributes, a = {}, Array.from(i).forEach(function(e) {
    ...
    }), sessionStorage.setItem("defaultAttribute", JSON.stringify(a)), x(a), (i = document.querySelector('.btn[data-bs-target="#theme-settings-offcanvas"]')) && i.click()), o = document.getElementById("search-close-options"), d = document.getElementById("search-dropdown"), (s = document.getElementById("search-options")) && (s.addEventListener("focus", function() {
        0 < s.value.length ? (d.classList.add("show"), o.classList.remove("d-none")) : (d.classList.remove("show"), o.classList.add("d-none"))
    }), s.addEventListener("keyup", function(e) {
        var n, t;
        0 < s.value.length ? (d.classList.add("show"), o.classList.remove("d-none"), n = s.value.toLowerCase(), t = document.getElementsByClassName("notify-item"), Array.from(t).forEach(function(e) {
            var t, a, o = "";
        ...
        })) : (d.classList.remove("show"), o.classList.add("d-none"))
    }), o.addEventListener("click", function() {
        s.value = "", d.classList.remove("show"), o.classList.add("d-none")
    }), document.body.addEventListener("click", function(e) {
        "search-options" !== e.target.getAttribute("id") && (d.classList.remove("show"), o.classList.add("d-none"))
    ...
    }), document.addEventListener("fullscreenchange", N), document.addEventListener("webkitfullscreenchange", N), document.addEventListener("mozfullscreenchange", N), r = document.getElementsByTagName("HTML")[0], (m = document.querySelectorAll(".light-dark-mode")) && m.length && m[0].addEventListener("click", function(e) {
        r.hasAttribute("data-layout-mode") && "dark" == r.getAttribute("data-layout-mode") ? F("data-layout-mode", "light", "layout-mode-light", r) : F("data-layout-mode", "dark", "layout-mode-dark", r)
    }), w(), k(), h(), document.getElementsByClassName("dropdown-item-cart") && (l = document.querySelectorAll(".dropdown-item-cart").length, Array.from(document.querySelectorAll("#page-topbar .dropdown-menu-cart .remove-item-btn")).forEach(function(e) {
        e.addEventListener("click", function(e) {
            l--, this.closest(".dropdown-item-cart").remove(), Array.from(document.getElementsByClassName("cartitem-badge")).forEach(function(e) {
                e.innerHTML = l
            }), H(), document.getElementById("empty-cart") && (document.getElementById("empty-cart").style.display = 0 == l ? "block" : "none"), document.getElementById("checkout-elem") && (document.getElementById("checkout-elem").style.display = 0 == l ? "none" : "block")
        })
